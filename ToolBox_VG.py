        ...
        with open(file_path, "r") as f:
            for line in f:
                if "," in line:
                    ...
                    print("La ligne suivante dans le fichier n'est pas au bon format:", line)
    except FileNotFoundError:
...
def create_pdf(scan_port_data, discovery_services_data, dirb_data, nikto_data, network_scan_data, hydra_usrmdp_data, hydra_identifiant_data, hydra_mdp_data, hydra_connexion_data, cve_port_data, cve_service_data, cve_os_data, output_pdf):
    ...
    cover = [
        ...
        Paragraph("ToolBox réalisé par Valentin G", styles['Normal'])
    ]
...
def main():
    ...
    while True:
        ...
        print("4. Exploitation de vulnérabilités")
...
#4
            ...
            while True:
                ...
                print("1. Attaque DDoS")
                print("2. Connexion au back d'or - Reverse Shell") 
                print("3. Retour au choix de l'outil")
